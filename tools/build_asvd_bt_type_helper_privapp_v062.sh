...
WORK="$HOME/asvd-bt-type-helper-v062"
MOD="$WORK/module"
...
OUT = Path('/data/data/com.termux/files/home/asvd-bt-type-helper-v062/AndroidManifest.xml')
...
printf '\nRESULT: ASVD_BT_TYPE_HELPER_PRIVAPP_V062_BUILD_DONE\n'
