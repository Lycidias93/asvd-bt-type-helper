...
WORK="$HOME/asvd-bt-type-helper-v073"
MOD="$WORK/module"
...
public class BtTypeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        add(out, "== ASVD BT Type Helper v0.5.9 ==");
...
OUT = Path('/data/data/com.termux/files/home/asvd-bt-type-helper-v073/AndroidManifest.xml')
...
strings = [
    ...
    'org.asvd.bttypehelper', '59', '0.5.9', '31', '35',
...
body += start_elem('manifest', [
    ...
    attr_android_int('versionCode', '59', 59),
    attr_android_str('versionName', '0.5.9'),
])
...
ui_print "- ASVD BT Type Helper v0.5.9"
ui_print "- Experimental privileged helper APK"
ui_print "- v0.5.9: Duplicate-safe picker, hard aborts for non-unique targets, action/current/last-device views"
...
BT_HELPER_VERSION="0.5.9"
BT_HELPER_VERSION_CODE="59"
...
echo "== ASVD BT Type Helper setup v0.5.9 =="
...
if [ -s "$PROP" ]; then
  ...
  /system/bin/grep -q "^versionCode=59$" "$PROP" && pass "versionCode=59" || warn "versionCode_not_59_or_unreadable"
...
while true; do
  echo "== ASVD BT Type Helper v0.5.9 =="
  echo "[1] Setup wizard"
