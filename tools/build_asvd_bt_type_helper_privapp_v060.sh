...
WORK="$HOME/asvd-bt-type-helper-v060"
MOD="$WORK/module"
...
public class BtTypeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        add(out, "== ASVD BT Type Helper v0.6.0 ==");
...
OUT = Path('/data/data/com.termux/files/home/asvd-bt-type-helper-v060/AndroidManifest.xml')
...
strings = [
    ...
    'org.asvd.bttypehelper', '60', '0.6.0', '31', '35',
...
body += start_elem('manifest', [
    ...
    attr_android_int('versionCode', '60', 60),
    attr_android_str('versionName', '0.6.0'),
])
...
ui_print "- ASVD BT Type Helper v0.6.0"
ui_print "- Experimental privileged helper APK"
ui_print "- v0.6.0: Duplicate-safe picker, hard aborts for non-unique targets, action/current/last-device views"
...
BT_HELPER_VERSION="0.6.0"
BT_HELPER_VERSION_CODE="60"
...
echo "== ASVD BT Type Helper setup v0.6.0 =="
...
if [ -s "$PROP" ]; then
  ...
  /system/bin/grep -q "^versionCode=60$" "$PROP" && pass "versionCode=60" || warn "versionCode_not_60_or_unreadable"
...
while true; do
  echo "== ASVD BT Type Helper v0.6.0 =="
  echo "[1] Setup wizard"
