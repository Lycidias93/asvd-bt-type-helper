...
WORK="$HOME/asvd-bt-type-helper-v058"
MOD="$WORK/module"
...
public class BtTypeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        add(out, "== ASVD BT Type Helper v0.5.2 ==");
...
OUT = Path('/data/data/com.termux/files/home/asvd-bt-type-helper-v058/AndroidManifest.xml')
...
strings = [
    ...
    'org.asvd.bttypehelper', '51', '0.5.2', '31', '35',
...
body += start_elem('manifest', [
    ...
    attr_android_int('versionCode', '52', 52),
    attr_android_str('versionName', '0.5.2'),
])
...
ui_print "- ASVD BT Type Helper v0.5.2"
ui_print "- Experimental privileged helper APK"
ui_print "- User-friendly v0.5.2: wizard, report, config, clear, experimental speaker/headphones types"
...
echo "== ASVD BT Type Helper setup v0.5.2 =="
...
printf '\nRESULT: ASVD_BT_TYPE_HELPER_PRIVAPP_V058_BUILD_DONE\n'
